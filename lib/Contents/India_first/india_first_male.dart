...
import 'package:chat_app/controller/India first/controller_first_male.dart';
...
class FeedbackListScreenMale extends StatelessWidget {
  @override
                ...
                child: Flex(
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                        flex: 1,
                        child: Container(
                          margin: EdgeInsets.only(bottom: 1, right: 30),
                          color: Colors.transparent,
                          child: Image.asset(
                            "assets/Images/malein.png",
