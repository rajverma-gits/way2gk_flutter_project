...
import 'package:chat_app/Response_to_json/Prime_minister.dart';
import 'package:chat_app/controller/Prime_minister.dart';
import 'package:chat_app/widgets/animator.dart';
import 'package:chat_app/  helper/constant.dart';
import 'package:auto_size_text/auto_size_text.dart';

class FeedbackListScreen10 extends StatelessWidget {
  @override
                  ...
                  itemBuilder: (context, index){
                    return Container(
                      ...
                      child: Animator(Card(
                        ...
                        child: ListTile(
                          onTap: (){
                            showDialogFunc(context, feedbackItems[index].pic, feedbackItems[index].name, feedbackItems[index].period);
                          },
                          title: Container(
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text("${feedbackItems[index].period}", style: TextStyle(color: kLightBlackColor),),
                                    ],
                                  ),
                                )
                              ],
